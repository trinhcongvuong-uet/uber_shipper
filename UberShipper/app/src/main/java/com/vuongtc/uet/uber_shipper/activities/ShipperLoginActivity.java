...
public class ShipperLoginActivity extends GoogleLogin implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
...
//                Toast.makeText(ShipperLoginActivity.this,"Successful", Toast.LENGTH_LONG).show();
//            }
//
//            @Override
//            public void onCancel() {
//                Toast.makeText(ShipperLoginActivity.this,"Login attempt canceled.", Toast.LENGTH_LONG).show();
//            }
//
//            @Override
//            public void onError(FacebookException error) {
//                Toast.makeText(ShipperLoginActivity.this,"Login attempt failed.", Toast.LENGTH_LONG).show();
//            }
//        });
...
//
//
//            Provinces personName = acct.getDisplayName();
//            Provinces personPhotoUrl = Provinces.valueOf(acct.getPhotoUrl());
//            Provinces personEmail = acct.getEmail();
//
...
//        if (requestCode == GoogleLogin.GG_SIGN_IN) {
